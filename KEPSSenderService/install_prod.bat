...
rem echo off
sc.exe \\krr-app-palbp01 Create "ArcelorMittal.OPCCommandsSender" binPath="C:\Nikama\opc_isa_service\KEPSSenderService.exe" start=delayed-auto obj=%ADMIN_USER% password=%ADMIN_PASS%
